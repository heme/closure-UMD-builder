...
(function() {
  ...
  if(goog.userAgent.IE) {
    ...
    b("AcroPDF.PDF.1") ? a = "7" : b("PDF.PdfCtrl.6") && (a = "6")
  }else {
    navigator.mimeTypes && 0 < navigator.mimeTypes.length && (b = navigator.mimeTypes["application/pdf"]) && b.enabledPlugin && (b = b.enabledPlugin.description) && -1 != b.indexOf("Adobe") && (a = -1 != b.indexOf("Version") ? b.split("Version")[1] : "7")
  }
  goog.userAgent.adobeReader.HAS_READER = !!a;
  goog.userAgent.adobeReader.VERSION = a;
  goog.userAgent.adobeReader.SILENT_PRINT = goog.userAgent.WINDOWS && 0 <= goog.string.compareVersions(a, "6")
})();
// Input 17
goog.userAgent.flash = {};
goog.userAgent.flash.ASSUME_NO_FLASH = !1;
goog.userAgent.flash.detectedFlash_ = !1;
goog.userAgent.flash.detectedFlashVersion_ = "";
goog.userAgent.flash.init_ = function() {
  if(navigator.plugins && navigator.plugins.length) {
    var a = navigator.plugins["Shockwave Flash"];
    a && (goog.userAgent.flash.detectedFlash_ = !0, a.description && (goog.userAgent.flash.detectedFlashVersion_ = goog.userAgent.flash.getVersion_(a.description)));
    navigator.plugins["Shockwave Flash 2.0"] && (goog.userAgent.flash.detectedFlash_ = !0, goog.userAgent.flash.detectedFlashVersion_ = "2.0.0.11")
  }else {
    if(navigator.mimeTypes && navigator.mimeTypes.length) {
      a = navigator.mimeTypes["application/x-shockwave-flash"], goog.userAgent.flash.detectedFlash_ = a && a.enabledPlugin, goog.userAgent.flash.detectedFlash_ && (goog.userAgent.flash.detectedFlashVersion_ = goog.userAgent.flash.getVersion_(a.enabledPlugin.description))
    }else {
      try {
        a = new ActiveXObject("ShockwaveFlash.ShockwaveFlash.7"), goog.userAgent.flash.detectedFlash_ = !0, goog.userAgent.flash.detectedFlashVersion_ = goog.userAgent.flash.getVersion_(a.GetVariable("$version"))
      }catch(b) {
        try {
          a = new ActiveXObject("ShockwaveFlash.ShockwaveFlash.6"), goog.userAgent.flash.detectedFlash_ = !0, goog.userAgent.flash.detectedFlashVersion_ = "6.0.21"
        }catch(c) {
          try {
            a = new ActiveXObject("ShockwaveFlash.ShockwaveFlash"), goog.userAgent.flash.detectedFlash_ = !0, goog.userAgent.flash.detectedFlashVersion_ = goog.userAgent.flash.getVersion_(a.GetVariable("$version"))
          }catch(d) {
          }
        }
      }
...
goog.userAgent.flash.getVersion_ = function(a) {
  a = a.match(/[\d]+/g);
  a.length = 3;
  return a.join(".")
};
goog.userAgent.flash.ASSUME_NO_FLASH || goog.userAgent.flash.init_();
...
goog.userAgent.flash.isVersion = function(a) {
  return 0 <= goog.string.compareVersions(goog.userAgent.flash.VERSION, a)
};
// Input 18
goog.userAgent.iphoto = {};
(function() {
  var a = !1, b = "";
  if(goog.userAgent.WEBKIT && navigator.mimeTypes && 0 < navigator.mimeTypes.length) {
    var c = navigator.mimeTypes["application/photo"];
    c && (a = !0, (c = c.description) && (b = c.match(/\d/g).join(".")))
  }
  goog.userAgent.iphoto.HAS_IPHOTO = a;
  goog.userAgent.iphoto.VERSION = b
})();
goog.userAgent.iphoto.isVersion = function(a) {
  return 0 <= goog.string.compareVersions(goog.userAgent.iphoto.VERSION, a)
};
// Input 19
...
(function() {
  var a = !1;
  goog.userAgent.IE ? (goog.global[goog.userAgent.picasa.IE_HAS_PICASA_] = a, document.write(goog.string.subs("\x3c!--[if gte Picasa 2]><%s>this.%s=true;</%s><![endif]--\x3e", "script", goog.userAgent.picasa.IE_HAS_PICASA_, "script")), a = goog.global[goog.userAgent.picasa.IE_HAS_PICASA_], goog.global[goog.userAgent.picasa.IE_HAS_PICASA_] = void 0) : navigator.mimeTypes && navigator.mimeTypes["application/x-picasa-detect"] && (a = !0);
  goog.userAgent.picasa.HAS_PICASA = a;
  goog.userAgent.picasa.VERSION = a ? "2" : ""
})();
goog.userAgent.picasa.isVersion = function(a) {
  return 0 <= goog.string.compareVersions(goog.userAgent.picasa.VERSION, a)
};
// Input 21
